  ...
  const features = [
    {
      ...
      description: "Our unique algorithm analyzes your spiritual values, energy, and aura to find truly compatible souls for meaningful connections."
    },
    {
      icon: (
        <svg fill="currentColor" viewBox="0 0 24 24" className="w-full h-full">
      ...
      description: "Every profile is manually verified to ensure authenticity. Connect with real people who are serious about finding genuine relationships."
    },
    {
      icon: (
        <svg fill="currentColor" viewBox="0 0 24 24" className="w-full h-full">
      ...
      description: "Connect with like-minded souls from around the world. Our platform breaks geographical barriers to help you find your perfect match."
    },
    {
      icon: (
        <svg fill="currentColor" viewBox="0 0 24 24" className="w-full h-full">
      ...
      description: "Your privacy is our priority. Advanced encryption, secure messaging, and complete control over your visibility and data."
    },
    {
      icon: (
        <svg fill="currentColor" viewBox="0 0 24 24" className="w-full h-full">
      ...
      description: "AI-powered matching considers your personality, interests, lifestyle, and spiritual alignment to suggest the most compatible partners."
    },
    {
      icon: (
        <svg fill="currentColor" viewBox="0 0 24 24" className="w-full h-full">
      ...
      description: "Get personalized advice from our relationship experts. Free resources, tips, and guidance to help you build lasting connections."
    }
  ]
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <header className="text-center mb-16 lg:mb-20">
          ...
          <p className="font-sans text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Experience a new dimension of online dating with features designed to help you find authentic, meaningful connections that align with your soul.
          </p>
        </header>
