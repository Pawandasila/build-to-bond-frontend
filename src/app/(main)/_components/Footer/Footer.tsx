...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-gradient-to-b from-background to-primary-50 border-t border-border" role="contentinfo">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-2">
              <div className="mb-6">
                ...
                <p className="text-muted-foreground text-sm mt-1">Find Your Soul Connection</p>
              </div>
              
              <p className="font-sans text-muted-foreground leading-relaxed mb-6 max-w-md">
                Where souls meet and auras align. Join thousands of people who have found meaningful relationships through authentic connections on Soulara.
              </p>
              ...
              <div className="mb-6">
                ...
                <p className="text-xs text-muted-foreground mt-2">
                  Get dating tips, success stories, and updates delivered to your inbox.
                </p>
              </div>
      ...
      {/* Decorative Elements */}
      <div className="absolute bottom-10 left-10 w-2 h-2 bg-primary-300 rounded-full opacity-30 animate-pulse" aria-hidden="true" />
      <div className="absolute bottom-20 right-16 w-3 h-3 bg-cream rounded-full opacity-40 animate-pulse delay-1000" aria-hidden="true" />
    </footer>
  )
}
