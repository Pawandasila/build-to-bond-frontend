      ...
      <div className="text-center max-w-4xl mx-auto">
        <header className="mb-8">
          <h1 className="font-playfair text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
            ...
            <span
              className="block text-primary-300 font-homemade-apple text-3xl sm:text-4xl md:text-5xl lg:text-6xl mt-2"
          ...
          <p
            className="font-sans text-lg sm:text-xl md:text-2xl text-white/90 mb-8 max-w-2xl mx-auto leading-relaxed"
            role="doc-subtitle"
