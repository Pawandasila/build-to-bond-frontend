...
const TrustIndicators: React.FC = () => {
  ...
  return (
    <aside 
      className="flex flex-col sm:flex-row items-center lg:items-start justify-center lg:justify-start gap-4 sm:gap-6 text-muted-foreground"
      aria-label="Trust indicators and platform benefits"
    >
      <ul className="flex flex-col sm:flex-row items-center lg:items-start justify-center lg:justify-start gap-4 sm:gap-6" role="list">
