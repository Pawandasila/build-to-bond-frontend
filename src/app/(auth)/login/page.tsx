  ...
  return (
    <>
      ...
      <div className="min-h-screen max-h-screen bg-gradient-to-br from-primary-50 via-background to-primary-100 dark:from-background dark:via-card dark:to-primary-950 flex items-center justify-center p-3 overflow-hidden">
        ...
        <div className="w-full max-w-4xl bg-card/95 dark:bg-card/95 backdrop-blur-xl rounded-2xl shadow-xl border border-border dark:border-border overflow-hidden relative max-h-[95vh]">
         
          
          <div className="flex flex-col lg:flex-row relative z-10 h-full">
            {/* Image Section */}
            <div className="lg:w-1/2 h-48 lg:h-auto relative group">
              ...
              <div className="absolute bottom-4 left-4 right-4">
                <div className="bg-card/95 dark:bg-card/95 backdrop-blur-sm rounded-xl p-3 transform translate-y-2 group-hover:translate-y-0 transition-transform duration-500">
                  <h3 className="text-base font-semibold text-foreground mb-1">Find Your Perfect Match</h3>
                  <p className="text-sm text-muted-foreground">Connect with like-minded souls and build meaningful relationships.</p>
                </div>
              </div>
            </div>

            {/* Form Section */}
            <div className="lg:w-1/2 p-4 lg:p-6 flex flex-col justify-center bg-gradient-to-b from-transparent to-background/50 dark:to-card/50">
